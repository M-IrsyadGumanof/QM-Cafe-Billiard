...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($faqs as [$cat,$q,$a]) {
            Faq::updateOrCreate(['question' => $q], ['category' => $cat, 'answer' => $a, 'status' => 'active']);
        }
        ...
        foreach ([
            ...
            Gallery::updateOrCreate(['title' => $title], ['description' => $desc, 'status' => 'active']);
        }
        ...
        ] as [$name,$message,$rating]) {
            Testimonial::updateOrCreate(['name' => $name], ['message' => $message, 'rating' => $rating, 'status' => 'active']);
        }
