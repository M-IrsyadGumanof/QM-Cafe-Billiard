            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-b border-[#222727] pb-6 mb-8 print:hidden">
                ...
                <div className="flex flex-wrap gap-2 shrink-0 self-start sm:self-center">
                    ...
                    <div className="relative group inline-block">
                        ...
                        <div className="absolute right-0 mt-1.5 w-48 rounded-xl border border-[#222727] bg-[#111515] py-2 shadow-xl opacity-0 scale-95 pointer-events-none group-hover:opacity-100 group-hover:scale-100 group-hover:pointer-events-auto transition-all duration-200 z-50 before:absolute before:-top-1.5 before:left-0 before:right-0 before:h-1.5 before:content-['']">
                            <a
