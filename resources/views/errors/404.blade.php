...
<head>
    ...
    <title>Halaman Tidak Ditemukan - {{ config('app.name', 'Laravel') }}</title>
...
<body class="antialiased min-h-screen text-slate-100 flex items-center justify-center p-4">
    ...
    <div class="max-w-md w-full glass-panel rounded-2xl p-8 md:p-10 text-center relative overflow-hidden">
        ...
        <!-- Magnifying Glass Icon (404 Not Found) -->
        <div class="relative w-24 h-24 mx-auto mb-8 flex items-center justify-center bg-brand/5 border border-brand/20 rounded-2xl shadow-inner group">
            ...
            <svg class="w-12 h-12 text-brand relative z-10 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
            </svg>
        </div>

        <!-- Title -->
        <h1 class="text-4xl font-extrabold text-brand mb-3 tracking-wide">404</h1>
        <h2 class="text-xl font-bold text-white mb-4 tracking-tight">Halaman Tidak Ditemukan</h2>
        
        <p class="text-slate-400 text-sm md:text-base mb-8 leading-relaxed">
            Maaf, halaman yang Anda cari tidak dapat ditemukan, telah dihapus, atau sedang tidak tersedia.
        </p>

        <!-- Action Button -->
        <div class="flex justify-center">
            <a href="{{ $homeUrl }}" target="_top" class="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-brand text-slate-900 font-extrabold hover:bg-brand-hover active:scale-95 transition-all duration-200 shadow-lg shadow-brand/10 text-sm">
